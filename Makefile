#############################################################################
# Makefile for building: testvcfreader
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = testvcfreader1.0.0
DISTDIR = /LINUX_DATA/dev/cutevariant/vcfreader/.tmp/testvcfreader1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -fPIC
LIBS          = $(SUBLIBS) -lz /usr/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		test.pro src/utils.h \
		src/value.h src/main.cpp \
		src/utils.cpp \
		src/value.cpp
...
testvcfreader:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: test.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/utils.h src/value.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/utils.cpp src/value.cpp $(DISTDIR)/
...
main.o: src/main.cpp lest/lest.hpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/testvcfreader/bin || mkdir -p $(INSTALL_ROOT)/opt/testvcfreader/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/testvcfreader/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/testvcfreader/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/testvcfreader/bin/ 
